...
const CategoryBubble: React.FC<Props> = ({ label }) => (
    <div className="group flex min-w-[70px] cursor-pointer flex-col items-center gap-2">
        <div className="h-14 w-14 rounded-full border border-gray-100 bg-gray-50 p-1 transition-all duration-300 group-hover:border-[#0455A4] group-hover:bg-blue-50 dark:border-gray-700 dark:bg-gray-800">
