        ...
        cell: ({ row }) => {
            const handleCopyLink = () => {
                ...
                if (post.category && post.slug) {
                    url = post.sub_category ? `/${post.category.slug}/${post.sub_category.slug}/${post.slug}` : `/${post.category.slug}/${post.slug}`;
                }
                if (url) navigator.clipboard.writeText(window.location.origin + url);
            };
            return (
