                            ...
                            <Card>
                                ...
                                <CardContent className="grid gap-3">
                                    <div className="flex flex-col gap-2 sm:flex-row">
                                        <Input placeholder="https://..." value={autoFillUrl} onChange={(e) => setAutoFillUrl(e.target.value)} className="flex-1" />
                                        <Button type="button" onClick={handleAutoFill} disabled={autoFillLoading || !autoFillUrl.trim()} className="shrink-0">
